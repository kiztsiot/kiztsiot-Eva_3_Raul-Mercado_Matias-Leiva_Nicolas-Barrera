...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.atoms.action-button','data' => ['onclick' => 'toggleModal(true)','variant' => 'primary']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['onclick' => 'toggleModal(true)','variant' => 'primary']); ?>+ Nuevo Proyecto <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
</div><?php /**PATH C:\Users\holan\Downloads\TechSolutions\TechSolutions\resources\views/components/organisms/project-dashboard.blade.php ENDPATH**/ ?>